...
use crate::{alloc::{self, Alloc}, chunk::{Chunk, Subchunk, SubchunkMeta, SubchunkMut}, consts::*, lightmap::{Light, LightMap}, palette::PaletteArray, voxel::{Voxel, VoxelData}};
...
pub struct Region {
    ...
    pub(crate) palettes: NonNull<PaletteArray<Alloc>>,
    pub(crate) lightmaps: NonNull<LightMap<Alloc>>,
    pub(crate) chunks: NonNull<Chunk>,
    pub(crate) metas: NonNull<SubchunkMeta>,
...
impl Region {
    ...
    pub(crate) unsafe fn get_palette_unchecked(&self, i: usize) -> &PaletteArray {
        debug_assert!(i < self.shape.num_subchunks);
...
mod tests {
    ...
    // #[test]
    // fn region_get_set() {
    //     let mut region = Region::new(IVec3::new(0, -64, 0), IVec3::new(512, 320, 512));
